...
('TRAIT_AGENDA_GRIMM',				'LOC_AGENDA_GRIMM_NAME',		'LOC_AGENDA_GRIMM_DESCRIPTION'			);
...
('AGENDA_GRIMM',					'LOC_AGENDA_GRIMM_NAME',		'LOC_AGENDA_GRIMM_DESCRIPTION'			);
...
('AGENDA_GRIMM',	    'TRAIT_AGENDA_GRIMM'	    );
...
('TRAIT_AGENDA_GRIMM',			'TRAIT_AGENDA_GRIMM_CULTURE'					);
...
('TRAIT_AGENDA_GRIMM_CULTURE',						'MODIFIER_PLAYER_DIPLOMACY_SIMPLE_MODIFIER',    0,          0,          0,      NULL,                   'PLAYER_HAS_HIGH_CULTURE'			);
...
('TRAIT_AGENDA_GOD_OF_GODS_LIKE_NO_GOLD_AGE',		'InitialValue',					'3'														,'ARGTYPE_IDENTITY'	), 
...
('TRAIT_AGENDA_GRIMM_CULTURE',						'InitialValue',					'25'													,'ARGTYPE_IDENTITY'	), 
('TRAIT_AGENDA_GRIMM_CULTURE',						'SimpleModifierDescription',	'LOC_TRAIT_AGENDA_GRIMM_CULTURE_DES'					,'ARGTYPE_IDENTITY'	), 
('TRAIT_AGENDA_GRIMM_CULTURE',						'StatementKey',					'LOC_TRAIT_AGENDA_GRIMM_CULTURE_KEY'					,'ARGTYPE_IDENTITY'	);
...
('TRAIT_AGENDA_GRIMM_CULTURE',							'Sample',	'LOC_TOOLTIP_SAMPLE_DIPLOMACY_ALL'	);

INSERT INTO AiListTypes
(ListType								        )       VALUES
('LEADER_RADIANCE_Settle'                       ),
('LEADER_RADIANCE_Units'						),
...
('LEADER_WYRMS_Yields'							),
('LEADER_GRIMM_Units'				),
('LEADER_GRIMM_Strategies'			),
('LEADER_GRIMM_Religious'			),
('LEADER_GRIMM_Alliances'			),
('LEADER_GRIMM_Buildings'			),
('LEADER_GRIMM_Civics'				),
('LEADER_GRIMM_Diplo'				),
('LEADER_GRIMM_Districts'			),
('LEADER_GRIMM_Techs'				),
('LEADER_GRIMM_Yields'				);
...
('LEADER_RADIANCE_Units'						, 'TRAIT_AGENDA_RADIANCE',   'Units'  ),
...
('LEADER_GOD_OF_GODS_WarMinor'						, 'TRAIT_AGENDA_GOD_OF_GODS',	'DiplomaticActions'),
...
('LEADER_WANDERER_Units'						, 'TRAIT_AGENDA_WANDERER',   'Units'),
...
('LEADER_WYRMS_Units'						 , 'TRAIT_AGENDA_WYRMS_2',   'Units'		 ),
...
('LEADER_GRIMM_Units'						 , 'TRAIT_AGENDA_GRIMM',   'Units'		 ),
('LEADER_GRIMM_Strategies'                   , 'TRAIT_AGENDA_GRIMM',   'Strategies'    ),
('LEADER_GRIMM_Religious'					 , 'TRAIT_AGENDA_GRIMM',   'TriggeredTrees'			),
('LEADER_GRIMM_Alliances'                    , 'TRAIT_AGENDA_GRIMM',   'Alliances'     ),
('LEADER_GRIMM_Buildings'                    , 'TRAIT_AGENDA_GRIMM',   'Buildings'     ),
('LEADER_GRIMM_Civics'                       , 'TRAIT_AGENDA_GRIMM',   'Civics'        ),
('LEADER_GRIMM_Diplo'                        , 'TRAIT_AGENDA_GRIMM',   'Diplo'         ),
('LEADER_GRIMM_Districts'                    , 'TRAIT_AGENDA_GRIMM',   'Districts'     ),
('LEADER_GRIMM_Techs'                        , 'TRAIT_AGENDA_GRIMM',   'Techs'         ),
('LEADER_GRIMM_Yields'                       , 'TRAIT_AGENDA_GRIMM',   'Yields'        );


INSERT INTO AiFavoredItems		
(ListType,							Favored,Value,  Item,						                StringVal	)	VALUES	
('LEADER_RADIANCE_Settle' ,         1,      0,		'Nearest Friendly City',                    null		),
('LEADER_RADIANCE_Units' ,			1,      -1,		'UNIT_MISSIONARY',							null		),
('LEADER_RADIANCE_Units' ,			1,      -2,		'UNIT_APOSTLE',								null		),
('LEADER_RADIANCE_Strategies' ,     1,      -30,	'VICTORY_STRATEGY_RELIGIOUS_VICTORY',       null		),
('LEADER_RADIANCE_Religious' ,      1,      -30,	'TRIGGER_RELIGIOUS_CITY_CONVERTED',         null		),
...
('LEADER_RADIANCE_Buildings',		1,		0,		'BUILDING_MONT_ST_MICHEL',				    null		),
('LEADER_RADIANCE_Buildings',		1,		-5,		'BUILDING_TEMPLE',				            null		),
('LEADER_RADIANCE_Buildings',		1,		-5,		'BUILDING_SHRINE',				            null		),
('LEADER_RADIANCE_Buildings',       1,      0,      'BUILDING_WALLS',							null		),
('LEADER_RADIANCE_Buildings',		1,		-9,		'BUILDING_HK_SPEC_TOWER',				    null		),
('LEADER_RADIANCE_Civics',			1,		-10,	'CIVIC_THEOLOGY',					        null		),
('LEADER_RADIANCE_Diplo',			1,		5,		'DIPLOACTION_OPEN_BORDERS',			        null		),
('LEADER_RADIANCE_Districts',		1,		-100,	'DISTRICT_TEMPLE_OF_THE_BLACK_EGG_SQUARE',	null		),
('LEADER_RADIANCE_Districts',		1,		-99,	'DISTRICT_PALACE_GROUNDS',					null		),
('LEADER_RADIANCE_Districts',		1,		0,		'DISTRICT_FLOURISHING_CROSSROADS',			null		),
('LEADER_RADIANCE_Techs',			1,		0,		'TECH_STIRRUPS',						    null		),
('LEADER_RADIANCE_Techs',		    1,	    -100,	'TECH_ASTROLOGY',						    null		),
('LEADER_RADIANCE_Techs',		    1,	    0,		'TECH_MASONRY',								null		),
('LEADER_RADIANCE_Yields',			0,	    20,		'YIELD_FAITH',								null		),
('LEADER_GOD_OF_GODS_WarMinor',		1,      -10,	'DIPLOACTION_DECLARE_WAR_MINOR_CIV',		null    ),
('LEADER_GOD_OF_GODS_Armys',		1,      -5,		'PROMOTION_CLASS_HEAVY_CAVALRY',			null    ),
('LEADER_GOD_OF_GODS_Armys',		1,      0,		'PROMOTION_CLASS_MELEE',					null    ),
('LEADER_GOD_OF_GODS_Strategies',   1,      -10,	'VICTORY_STRATEGY_MILITARY_VICTORY',        null    ),
('LEADER_GOD_OF_GODS_Alliances',    1,      0,		'ALLIANCE_RESEARCH',                        null    ),
...
('LEADER_GOD_OF_GODS_Buildings',    1,      1,		'BUILDING_COLOSSEUM_OF_FOOLS',              null    ),
('LEADER_GOD_OF_GODS_Buildings',    1,      2,      'BUILDING_TERRACOTTA_ARMY',                 null    ),
('LEADER_GOD_OF_GODS_Buildings',	1,		-9,		'BUILDING_HK_SPEC_TOWER',				    null		),
('LEADER_GOD_OF_GODS_Civics',       1,      0,      'CIVIC_MILITARY_TRADITION',                 null    ),
('LEADER_GOD_OF_GODS_Diplo',        1,      -5,     'DIPLOACTION_DECLARE_SURPRISE_WAR',         null    ),
('LEADER_GOD_OF_GODS_Districts',    1,      -5,		'DISTRICT_FLOURISHING_CROSSROADS',          null	),
('LEADER_GOD_OF_GODS_Districts',    1,      -50,	'DISTRICT_TEMPLE_OF_THE_BLACK_EGG_SQUARE',  null    ),
('LEADER_GOD_OF_GODS_Districts',    1,      0,		'DISTRICT_ENCAMPMENT',                      null    ),
('LEADER_GOD_OF_GODS_Districts',    0,      0,		'DISTRICT_PALACE_GROUNDS',					null    ),
('LEADER_GOD_OF_GODS_Techs',        1,      0,      'TECH_HORSEBACK_RIDING',                    null    ),
('LEADER_GOD_OF_GODS_Techs',        1,      -10,    'TECH_STIRRUPS',                            null    ),
('LEADER_GOD_OF_GODS_Techs',        1,      0,      'TECH_BALLISTICS',                          null    ),
('LEADER_GOD_OF_GODS_Techs',        1,      -10,    'TECH_THE_WHEEL',                           null    ),
('LEADER_GOD_OF_GODS_Techs',        1,      0,      'TECH_COMBUSTION',                          null    ),
('LEADER_GOD_OF_GODS_Techs',        1,      0,      'TECH_CURRENCY',                            null    ),
('LEADER_GOD_OF_GODS_Techs',        1,      -3,     'TECH_IRON_WORKING',                        null    ),
('LEADER_GOD_OF_GODS_Yields',       1,      0,		'YIELD_GOLD',								null    ),
('LEADER_WANDERER_Settle' ,         1,      2,      'Foreign Continent',                        null    ),
('LEADER_WANDERER_Units' ,			1,      -15,	'UNIT_SETTLER',                             null    ),
...
('LEADER_WANDERER_Buildings',       1,      0,      'BUILDING_TEACHERS_ARCHIVES',               null    ),
('LEADER_WANDERER_Buildings',       1,      0,      'BUILDING_WALLS',							null    ),
('LEADER_WANDERER_Buildings',		1,		-9,		'BUILDING_HK_SPEC_TOWER',				    null		),
('LEADER_WANDERER_Civics',          1,      0,      'CIVIC_EARLY_EMPIRE',                       null    ),
('LEADER_WANDERER_Diplo',           1,      -20,    'DIPLOACTION_ALLIANCE_TEAMUP',              null    ),
('LEADER_WANDERER_Districts',       1,      -99,    'DISTRICT_TEMPLE_OF_THE_BLACK_EGG_SQUARE',  null    ),
('LEADER_WANDERER_Districts',       1,      -50,    'DISTRICT_FLOURISHING_CROSSROADS',          null    ),
('LEADER_WANDERER_Districts',       1,      0,      'DISTRICT_CAMPUS',                          null    ),
('LEADER_WANDERER_Techs',		    1,	    0,		'TECH_MASONRY',								null	),
('LEADER_WANDERER_Techs',           1,      0,      'TECH_SHIPBUILDING',                        null    ),
('LEADER_WANDERER_Techs',           1,      0,      'TECH_STIRRUPS',                            null    ),
('LEADER_WANDERER_Techs',           1,      -2,     'TECH_CURRENCY',                            null    ),
('LEADER_WANDERER_Yields',          0,      15,     'YIELD_SCIENCE',                            null    ),
('LEADER_WYRMS_Settle' ,            1,      -4,		'Nearest Friendly City',                    null    ),
('LEADER_WYRMS_Units'	,			1,      0,		'UNIT_SETTLER',                             null    ),
('LEADER_WYRMS_Strategies' ,        1,      0,		'VICTORY_STRATEGY_SCIENCE_VICTORY',         null    ),
('LEADER_WYRMS_Alliances',          1,      0,		'ALLIANCE_RESEARCH',                        null    ),
('LEADER_WYRMS_Alliances',          1,      0,      'ALLIANCE_CULTURAL',                        null    ),
('LEADER_WYRMS_Alliances',          1,      0,      'ALLIANCE_ECONOMIC',                        null    ),
('LEADER_WYRMS_Alliances',          1,      5,      'ALLIANCE_MILITARY',                        null    ),
('LEADER_WYRMS_Alliances',          1,      5,      'ALLIANCE_RELIGIOUS',                       null    ),
('LEADER_WYRMS_Buildings',          1,      3,      'BUILDING_TEACHERS_ARCHIVES',               null    ),
('LEADER_WYRMS_Buildings',          1,      5,      'BUILDING_PLEASURE_HOUSE',                  null    ),
('LEADER_WYRMS_Buildings',          1,      0,      'BUILDING_TEMPLE',                          null    ),
('LEADER_WYRMS_Buildings',          1,      -1,     'BUILDING_SHRINE',                          null    ),
('LEADER_WYRMS_Buildings',          1,      3,      'BUILDING_UNIVERSITY',                      null    ),
('LEADER_WYRMS_Buildings',          1,      0,      'BUILDING_PYRAMIDS',                        null    ),
('LEADER_WYRMS_Buildings',          1,      1,      'BUILDING_OXFORD_UNIVERSITY',               null    ),
('LEADER_WYRMS_Buildings',          1,      1,      'BUILDING_FORBIDDEN_CITY',                  null    ),
('LEADER_WYRMS_Buildings',			1,      -4,     'BUILDING_WALLS',							null    ),
('LEADER_WYRMS_Buildings',			1,		-9,		'BUILDING_HK_SPEC_TOWER',				    null		),
('LEADER_WYRMS_Civics',             1,      0,		'CIVIC_FEUDALISM',                          null    ),
('LEADER_WYRMS_Diplo',              1,      -5,     'DIPLOACTION_ALLIANCE_TEAMUP',              null    ),
...
('LEADER_WYRMS_Districts',          1,      -20,    'DISTRICT_PALACE_GROUNDS',                  null    ),
('LEADER_WYRMS_Districts',          1,      -4,     'DISTRICT_CAMPUS',                          null    ),
('LEADER_WYRMS_Techs',				1,	    0,		'TECH_MASONRY',								null	),
('LEADER_WYRMS_Techs',              1,      1,      'TECH_STIRRUPS',                            null    ),
('LEADER_WYRMS_Techs',              1,      -5,     'TECH_CURRENCY',                            null    ),
('LEADER_WYRMS_Yields',             1,      5,      'YIELD_SCIENCE',                            null    ),
('LEADER_GRIMM_Units'	,			1,      0,		'UNIT_SETTLER',                             null    ),
('LEADER_GRIMM_Strategies' ,        1,      0,		'VICTORY_STRATEGY_SCIENCE_VICTORY',         null    ),
('LEADER_GRIMM_Strategies' ,        1,      -1,		'VICTORY_STRATEGY_CULTURAL_VICTORY',        null    ),
('LEADER_GRIMM_Alliances',          1,      99,		'ALLIANCE_RESEARCH',                        null    ),
('LEADER_GRIMM_Alliances',          1,      -10,    'ALLIANCE_CULTURAL',                        null    ),
('LEADER_GRIMM_Alliances',          1,      5,      'ALLIANCE_ECONOMIC',                        null    ),
('LEADER_GRIMM_Alliances',          1,      5,      'ALLIANCE_MILITARY',                        null    ),
('LEADER_GRIMM_Alliances',          1,      5,      'ALLIANCE_RELIGIOUS',                       null    ),
('LEADER_GRIMM_Buildings',          1,      -30,    'BUILDING_PLEASURE_HOUSE',                  null    ),
('LEADER_GRIMM_Buildings',          1,      -30,    'BUILDING_MUSEUM_ART',						null    ),
('LEADER_GRIMM_Buildings',          1,      -2,     'BUILDING_TEMPLE',                          null    ),
('LEADER_GRIMM_Buildings',          1,      -2,     'BUILDING_SHRINE',                          null    ),
('LEADER_GRIMM_Buildings',          1,      1,      'BUILDING_FORBIDDEN_CITY',                  null    ),
('LEADER_GRIMM_Buildings',			1,      0,      'BUILDING_WALLS',							null    ),
('LEADER_GRIMM_Buildings',			1,		-9,		'BUILDING_HK_SPEC_TOWER',				    null		),
('LEADER_GRIMM_Civics',             1,      -1,		'CIVIC_FEUDALISM',                          null    ),
('LEADER_GRIMM_Civics',             1,      -5,		'CIVIC_DRAMA_POETRY',                       null    ),
('LEADER_GRIMM_Diplo',              1,      -5,     'DIPLOACTION_ALLIANCE_TEAMUP',              null    ),
('LEADER_GRIMM_Districts',          1,      -100,   'DISTRICT_TEMPLE_OF_THE_BLACK_EGG_SQUARE',  null    ),
('LEADER_GRIMM_Districts',          1,      -5,		'DISTRICT_FLOURISHING_CROSSROADS',          null    ),
('LEADER_GRIMM_Districts',          1,      -20,    'DISTRICT_PALACE_GROUNDS',                  null    ),
('LEADER_GRIMM_Districts',          1,      -21,	'DISTRICT_THEATER',                         null    ),
('LEADER_GRIMM_Techs',				1,	    -100,	'TECH_ASTROLOGY',							null	),
('LEADER_GRIMM_Techs',              1,      0,      'TECH_STIRRUPS',                            null    ),
('LEADER_GRIMM_Techs',              1,      -5,     'TECH_CURRENCY',                            null    ),
('LEADER_GRIMM_Yields',             1,      0,		'YIELD_CULTURE',                            null    );



INSERT INTO FavoredReligions
(LeaderType,					ReligionType		) VALUES
('LEADER_RADIANCE',				'RELIGION_TAOISM'	),
('LEADER_GRIMM',				'RELIGION_ZOROASTRIANISM'	);
